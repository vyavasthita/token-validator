...
from jwt_lib.exceptions import PermissionDeniedError, InvalidClaimError
...
class TestRequireScopes:
    ...
    @pytest.mark.asyncio
    async def test_passes_when_all_scopes_present(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_scope_missing(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_no_scope_claim(self):
...
class TestRequireAnyScope:
    ...
    @pytest.mark.asyncio
    async def test_passes_when_at_least_one_scope_present(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_no_acceptable_scope_present(self):
...
class TestRequireGrantType:
    ...
    @pytest.mark.asyncio
    async def test_passes_when_grant_type_matches(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_grant_type_differs(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_grant_type_missing(self):
...
class TestRequireClaim:
    ...
    @pytest.mark.asyncio
    async def test_passes_when_claim_present_no_value_check(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_claim_missing(self):
    ...
    @pytest.mark.asyncio
    async def test_passes_when_claim_matches_expected_value(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_claim_value_differs(self):
...
class TestRequireSubject:
    ...
    @pytest.mark.asyncio
    async def test_passes_when_subject_matches(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_subject_differs(self):
    ...
    @pytest.mark.asyncio
    async def test_fails_when_subject_missing(self):
